...
app.use(
  session({
    secret: process.env.SESSION_SECRET || "calorie-track-secret-key-12345",
    resave: false,
...
if (fs.existsSync(generatedImagesPath)) {
  ...
  console.log("[Static] Serving generated images at /generated_images/");
} else {
  console.warn("[Warning] generated_images folder not found at:", generatedImagesPath);
}
